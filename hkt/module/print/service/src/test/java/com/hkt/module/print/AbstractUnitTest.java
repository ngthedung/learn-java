...
@ContextConfiguration(locations = { 
    ...
    "classpath:META-INF/spring/module.accounting.service.xml",
    "classpath:META-INF/spring/module.print.service.xml",
    "classpath:META-INF/spring/module.restaurant.service.xml"})

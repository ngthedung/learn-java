...
function CreatePaymenOdd(frameui) {
	...
	dlChild.buttonClickByName("ScreenOften_PaymenOdd");
	
	var dlPaymentSP = frameui.dialog("dlScreenOften_PaymenOdd");
	var pnPaymentSP= dlPaymentSP.panel("ScreenOften_PaymenOdd");
	
	var tableL = pnPaymentSP.table("tableL");
	tableL.selectRow("Sản phẩm HktTest3");
	dlPaymentSP.buttonClick(">");
...
var robot = new Robot();
robot.add("TEST PaymenOdd ", "", CreatePaymenOdd);
console.clear();
robot.run();
robot.report();
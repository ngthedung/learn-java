 ...
 * @author longnt
 */
public class MouseEventKeyboard extends MouseAdapter {
...
//    private String image3="";
    //
    public MouseEventKeyboard() {
    }

    public MouseEventKeyboard(String pathSource, String image1, String image2, String image3) {
...
//        getImage();
    ...
    public MouseEventKeyboard(ImageIcon imageIcon1, ImageIcon imageIcon2, ImageIcon imageIcon3) {
...
//        button.setIcon(imageIcon3);
        button.setMargin(new Insets(6, 6, 0, 0));

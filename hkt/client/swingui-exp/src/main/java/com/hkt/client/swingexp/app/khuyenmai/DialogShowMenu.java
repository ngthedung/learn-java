...
import com.hkt.client.swingexp.app.khuyenmai.list.TableModelMenuItem;
...
public class DialogShowMenu extends MyPanel implements IPanelListProduct, IDialogMain, IMyObserver {
  ...
  private ExtendJRadioButton checkbKhaiVi, checkbMonChinh, checkbTrangMieng, checkbCoDinh, checkbTuyChon;
  private GroupType groupTypeMenu;
  ...
  private TableModelMenuItem modelMenuItem;
  public static String permission;
  private boolean reset = false;

  public DialogShowMenu() {
    createBeginTest();
  ...
  public DialogShowMenu(Menu menu) {
    this.menu = menu;
          ...
          public void mouseClicked(MouseEvent e) {
            if (e.getButton() == MouseEvent.BUTTON3) {
              ...
              try {
                ...
                try {
                  comboGroup.setModel(new DefaultComboBoxModel(ProductModelManager.getInstance().getProductTags()
                      .toArray()));
                } catch (Exception e1) {
  ...
  public class PanelMenuSP_START extends GridBagLayoutPanel {
    ...
    public PanelMenuSP_START() {
      setOpaque(false);
      lbTen = new ExtendJLabel("Tên Menu");
      ...
      checkbKhaiVi = new ExtendJRadioButton("Khai vị");
      checkbKhaiVi.setName("checkbKhaiVi");
      checkbKhaiVi.addActionListener(new ActionListener() {

        @Override
        public void actionPerformed(ActionEvent e) {
          groupTypeMenu = GroupType.Appetizer;
        }
      });
      checkbKhaiVi.setSelected(true);
      checkbMonChinh = new ExtendJRadioButton("Món chính");
      checkbMonChinh.setName("checkbMonChinh");
      checkbMonChinh.addActionListener(new ActionListener() {

        @Override
        public void actionPerformed(ActionEvent e) {
          groupTypeMenu = GroupType.MainDishes;
        }
      });
      checkbTrangMieng = new ExtendJRadioButton("Tráng miệng");
      checkbTrangMieng.setName("checkbTrangMieng");
      checkbTrangMieng.addActionListener(new ActionListener() {

        @Override
        public void actionPerformed(ActionEvent e) {
          groupTypeMenu = GroupType.Dessert;

        }
      });
      ButtonGroup groupType = new ButtonGroup();
      groupType.add(checkbKhaiVi);
      groupType.add(checkbMonChinh);
      groupType.add(checkbTrangMieng);
      ...
      cbUnitMoney.setName("cbUnitMoney");
      ...
      btnClick.addMouseListener(new MouseEventClickButtonDialogPlus(null, null, null));
        ...
        public void actionPerformed(ActionEvent e) {
          try {
            ...
            if (btnClick.getText().equals("Sửa tùy chọn")) {
              ...
              menuItemRef.setName("ThemTuyChon");
        ...
        public void mouseClicked(MouseEvent e) {
          if (e.getButton() == MouseEvent.BUTTON3) {
            ...
            try {
              ...
              dialog.setVisible(true);
              try {
                cbUnitMoney.setModel(new DefaultComboBoxModel(LocaleModelManager.getInstance().getCurrencies()
                    .toArray()));
              } catch (Exception e1) {
      ...
      add(2, 0, lbLoaiNhom);
      add(2, 1, checkbKhaiVi);
      add(2, 2, checkbMonChinh);
      add(2, 3, checkbTrangMieng);

      add(3, 0, lbKieu);
      add(3, 1, checkbCoDinh);
      add(3, 2, checkbTuyChon);
      add(3, 3, btnClick);

      if (checkbKhaiVi.isSelected() == true) {
        groupTypeMenu = GroupType.Appetizer;
      }
      if (checkbMonChinh.isSelected() == true) {
        groupTypeMenu = GroupType.MainDishes;
      }
      if (checkbTrangMieng.isSelected() == true) {
        groupTypeMenu = GroupType.Dessert;
      }
      ...
      if (checkbTuyChon.isSelected() == true) {
      }
    }
  ...
  public class PanelMenuSP_CENTER extends JPanel {
    ...
    public PanelMenuSP_CENTER() {
      ...
      labelErr.setText("");
      labelErr.setPreferredSize(new Dimension(200, 23));
    ...
    public class PanelMenuSP_CENTER_1 extends JPanel {
      ...
      public PanelMenuSP_CENTER_1() {
        ...
        tableSPchinh.addKeyListener(new KeyAdapter() {
          ...
          public void keyPressed(KeyEvent e) {
            if (e.getKeyCode() == KeyEvent.VK_DELETE) {
              int reply = JOptionPane.showConfirmDialog(null, "Bạn muốn xóa ?", "Xóa menu", JOptionPane.YES_NO_OPTION);
        ...
        modelMenuItem = new TableModelMenuItem(new ArrayList<MenuItem>());
        ...
        tableSPchinh.addMouseListener(new MouseAdapter() {
          ...
          public void mouseClicked(MouseEvent e) {
            ...
            GroupType groupType = menuItem.getGroupType();
            if (groupType == GroupType.Appetizer) {
              checkbKhaiVi.setSelected(true);
            } else if (groupType == GroupType.MainDishes) {
              checkbMonChinh.setSelected(true);
            } else {
              checkbTrangMieng.setSelected(true);
            }
        ...
        setBorder(BorderFactory.createTitledBorder(null, "Danh sách các sản phẩm chính", TitledBorder.LEFT,
  ...
  public void addProduct(Product product) {
    ...
    if (!flag) {
      ...
      menuItem.setGroupType(groupTypeMenu);
  ...
  private void loadTableMenuItem() {
    ...
    tableSPchinh.getColumnModel().getColumn(3).setCellRenderer(new DefaultTableCellRenderer() {
  ...
  public boolean check() {
    if (txtTen.getText().trim().length() == 0) {
      ...
      labelErr.setText("Nhập tên Menu");
      return false;
    }
    if (txtTienBan.getText().trim().length() == 0) {

      labelErr.setText("Nhập tiền bán Menu");
      return false;
    }
    if (menuItems.size() == 0) {

      labelErr.setText("Menu không có sản phẩm");
      return false;
    }
    try {

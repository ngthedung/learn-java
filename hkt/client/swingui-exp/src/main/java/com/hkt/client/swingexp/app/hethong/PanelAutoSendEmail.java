...
public class PanelAutoSendEmail extends JPanel implements IDialogMain {
  ...
  public PanelAutoSendEmail() throws Exception {
    setOpaque(false);
    ...
    lbLocation = new JLabel("Mail được nhận");
  ...
  private void addData() {
    if (!checkData()) {
      ...
      try {
        ...
        File fileAutoSave = new File(LOCATION_URL + "/automail.txt");

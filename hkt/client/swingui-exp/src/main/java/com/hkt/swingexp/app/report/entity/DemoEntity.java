...
public class DemoEntity {
	...
	private List<DemoEntity>	listChild;
	...
	public DemoEntity(String node, String column1, String column2, String column3, int index) {
		this.node = node;
	...
	public DemoEntity(String node, String column1, String column2, String column3, String column4, String column5, String column6, String column7, int index) {
		this.node = node;
		this.column1 = column1;
		this.column2 = column2;
		this.column3 = column3;
	...
	public List<DemoEntity> getListChild() {
		return listChild;
	}

	public void setListChild(List<DemoEntity> listChild) {

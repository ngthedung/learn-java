...
public class CurrencyTable extends BeanBindingJTable<Currency> {
	...
	public void setCurrencys(List<Currency> currency) {
		init(HEADERS, PROPERTIES, currency);
		setRowHeight(23);
	...
	public void saveIndex() {
		try {
			for (int i = 0; i < getBeans().size(); i++) {
				...
				clientCore.saveCurrency(getBeans().get(i));
			}

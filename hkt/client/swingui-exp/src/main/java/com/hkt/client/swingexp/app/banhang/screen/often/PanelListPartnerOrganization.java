...
public class PanelListPartnerOrganization extends JPanel implements IDialogResto {
	...
	public PanelListPartnerOrganization() {
		init();
	}
...
//	public void click(final Customer customer)
//	{
//		table = new TableManagePartner(customers);
//		table.setName("table");
//		table.addMouseListener(new MouseAdapter() {
...
//				if (e.getClickCount() >= click) {
////					try {
////						PanelToDoWork panelToDoWork = new PanelToDoWork();
////						panelToDoWork.setCustomer(customer);
////						DialogMain dialogMain = new DialogMain(panelToDoWork);
////						dialogMain.setTitle("Công việc");

          ...
          actions: [
            {
              ...
              onClick: function(thisUI) { 
                ...
                UIPopup.activate(new AccountTest.UIAccount().init(thisUI, account, true)) ;
              } 
            },
            {
                action: "onFullNew", icon: "plus", label: res('UIAccountList.action.onFullNew'),
                onClick: function(thisUI) { 
                  var account = { 
                    type : 'USER', loginId : "",
                    profiles : { basic : { firstName : '', lastName : '' } }
                  };
                  var aview = new AccountTestFull.UIAccountTestFull().init(thisUI, account);
...
//                  UIPopup.activate(new AccountTest.UIAccount().init(thisUI, account, true)) ;
        ...
        actions: [
          {
            ...
            onClick: function(thisUI, row) { 
              var account = thisUI.getItemOnCurrentPage(row) ;
              var uiAccount = new AccountTest.UIAccountDetail().init(thisUI, account, false);
    ...
    init: function (viewStack) {
      ...
      this.UIAccountDetail = new AccountTest.UIAccountDetail() ;
      var result = service.AccountService.filterAccount(null).data ;
      var users = result.data ;
      this.setBeans(users) ;
      return this ;

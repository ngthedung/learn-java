define([
  ...
  'ui/UITreeTable',
            ...
            UICollabsible, UIBean, UITable, UITreeTable) {
  ...
  var UISamples = module.UIScreen.extend({
    ...
    activate: function() { 
      ...
      UICollabsible.add(singleUIBean, true) ;
      ...
      UICollabsible.add(sampleUITable, true) ;
      
      var uiTreeTableSample = new UITreeTableSample() ;
      var node_1 = uiTreeTableSample.addNode({});
      var node_1_1 = node_1.addChild({});
      node_1.setCollapsed(false);
      var node_2 = uiTreeTableSample.addNode({});
      var node_2_1 = node_2.addChild({});
      UICollabsible.add(uiTreeTableSample, false) ;

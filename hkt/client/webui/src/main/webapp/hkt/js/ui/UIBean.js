define([
  ...
  var UIBean = Backbone.View.extend({
    ...
    onAddInput: function(evt) {
      ...
      inputBlock.append(
        '<input class="onChangeInput" type="text" name="' + (fieldName + '@'  + idx)+ '"' + 
    ...
    onFocusDatePickerInput: function(evt) {
      ...
      var fieldConfig = this._getBeanFieldConfig(beanConfig, fieldName) ;
      evt.stopPropagation();
      console.log('on focus bean = ' + beanName + ", field name " + fieldName + ", event = " + evt) ;
    },
    ...
    onBlurDatePickerInput: function(evt) {
      ...
      console.log('on blur bean = ' + beanName + ", field name " + fieldName + ", date val =" + dateVal+ ", event = " + evt) ;
      setTimeout(function() {
        var dateVal = $(evt.target).val() ;
        console.log('on blur set timeout bean = ' + beanName + ", field name " + fieldName + ", date val =" + dateVal) ;
